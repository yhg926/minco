# KSSDmini Cross-Read ANI Against Assembly Truth
...
`Salmonella enterica` samples, then test whether KSSDmini raw-read ANI is close
to that truth for:
...
```text
/home/ubuntu/yihuiguang/tools/KSSD3mini/bin/kssd3mini_stage3_native
```
...
For this close same-species pair, patched KSSDmini raw-read ANI tracks the
