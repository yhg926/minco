...
"$KSSD" sketch -p 4 --ctxmeta both \
  -o /tmp/kssdmini_asm_2010K1947_0618 \
...
"$KSSD" sketch -p 4 --conflict --readsQC --ctxmeta both \
  -o /tmp/kssdmini_readsqc_2010K1947_yield_0618 \
...
"$KSSD" ani -r /tmp/kssdmini_asm_2010K1947_0618 \
  --qraw /tmp/kssdmini_readsqc_kssdqcsample_counts_all_0618 \
  -n0 -f0 -t0 -s4 -m0 \
  -o /tmp/kssdmini_2009reads_vs_2010asm_readsqc_0618.tsv

"$KSSD" ani -r /tmp/kssdmini_asm_2009K1545_0618 \
  --qraw /tmp/kssdmini_readsqc_2010K1947_yield_0618 \
  -n0 -f0 -t0 -s4 -m0 \
  -o /tmp/kssdmini_2010reads_vs_2009asm_readsqc_0618.tsv

"$KSSD" ani -r /tmp/kssdmini_readsqc_2010K1947_yield_0618 \
  --qraw /tmp/kssdmini_readsqc_kssdqcsample_counts_all_0618 \
  -n0 -f0 -t0 -s4 -m0 \
  -o /tmp/kssdmini_2009reads_vs_2010reads_readsqc_0618.tsv

"$KSSD" ani -r /tmp/kssdmini_readsqc_kssdqcsample_counts_all_0618 \
  --qraw /tmp/kssdmini_readsqc_2010K1947_yield_0618 \
  -n0 -f0 -t0 -s4 -m0 \
  -o /tmp/kssdmini_2010reads_vs_2009reads_readsqc_0618.tsv
