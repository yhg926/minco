# KSSDmini ONT yield density estimator accuracy

Date: 2026-06-18
Author/agent: ubuntu
Project: KSSD3mini
Code commit: NA
KSSD3A binary/tool version: kssd3mini_stage3_native + exact20m/exact100m

## Question

Does the KSSDmini bottom-k density estimator remain accurate for error-prone
...
Exact validation:
  ...
  50m,75m,100m,250m:
    bin/kssd3mini_exact100m sketch -p 2 --conflict --ctxmeta both
    KSSD3MINI_SKETCH_SIZE=100000000
...
Exploratory: KSSDmini's fixed 10,000-entry bottom-k density estimator can
