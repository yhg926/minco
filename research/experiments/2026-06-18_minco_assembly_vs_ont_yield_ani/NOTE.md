# minco assembly-vs-ONT-yield ANI for 2009K-1545
...
```text
bin/minco_stage3_native sketch -p 4 --ctxmeta both
```
...
After changing minco to infer `--readsQC` ranges from a KSSD3A-style
...
- minco raw-read ANI currently uses the naive raw-read metric.
