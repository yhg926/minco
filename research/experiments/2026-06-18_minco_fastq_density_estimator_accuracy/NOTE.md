# minco FASTQ density estimator accuracy
...
How accurately does the minco bottom-k density estimator predict unique
...
Full FASTQ check:
  bin/minco_stage3_native sketch -p 8 --conflict --ctxmeta both
...
Exploratory: minco's 10,000-entry bottom-k density estimator estimates FASTQ
