...
WORK="$WORK_ROOT/minco_current_code_hmp_airskin21_20260627"
...
python3 -B research/experiments/2026-06-27_universal_strategy_decision/score_hmp_gtdb_source_abundance.py \
  ...
  --minco-method "minco_current_default_gtdb_source_abundance_sample${SAMPLE}_0_5_6_11_22_28" \
  --output-prefix "hmp_current_refresh_r232_source_abundance_sample${SAMPLE}_0_5_6_11_22_28"
