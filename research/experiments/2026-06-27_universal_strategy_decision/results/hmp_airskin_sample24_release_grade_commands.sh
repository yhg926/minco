...
WORK="$WORK_ROOT/minco_current_code_hmp_airskin24_20260627"
...
python3 -B research/experiments/2026-06-27_universal_strategy_decision/score_hmp_gtdb_source_abundance.py \
  --samples "${SAMPLE},0,1,3,5,6,11,13,17,18,21,22,25,28" \
  --sylph-source r232 \
  --r232-run /tmp/cami2_hmp_unseen_transfer_20260626/run_sylph_r232 \
  --minco-sample "${SAMPLE}=$WORK/minco_sample${SAMPLE}_current_default.tsv" \
  --minco-unique-sample "${SAMPLE}=$WORK/work/minco.best_diff_unique.unfiltered.tsv" \
  ...
  --minco-method "minco_current_default_gtdb_source_abundance_sample${SAMPLE}_0_1_3_5_6_11_13_17_18_21_22_25_28" \
  --output-prefix "hmp_current_refresh_r232_source_abundance_sample${SAMPLE}_0_1_3_5_6_11_13_17_18_21_22_25_28"
